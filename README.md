...
| ---- | ------ | ----------- | ----- |
| ![GazeboModularScara3DOF-v2.png](imgs/GazeboModularScara3DOF-v2.png)`GazeboModularScara3DOF-v2` | ROS |
...
to this value (slowness). In other words, actions are taken at "1/slowness" rate.| TBD |
