...
from gym_gazebo.envs import real_env_ros2
...
class RealModularMara3DOFv0EnvROS2(real_env_ros2.RealEnvROS2):
    """
    ...
    def __init__(self):
        ...
        real_env_ros2.RealEnvROS2.__init__(self)
        ...
        EE_POS_TGT = np.asmatrix([-0.48774951, -0.00298082,  0.73539824])
        EE_ROT_TGT = np.asmatrix([[-0.99170496, -0.12600662, -0.02536944], [ 0.1248146,  -0.99120003,  0.04408875], [-0.03070167,  0.04055656,  0.99870545]])
        ...
        JOINT_PUBLISHER = '/mara_controller/commandMotor'
        JOINT_SUBSCRIBER = '/mara_controller/stateMotor'
...
#       /mara_controller/stateMotor control_msgs/JointTrajectoryControllerState
#       /mara_controller/commandMotor trajectory_msgs/JointTrajectory
