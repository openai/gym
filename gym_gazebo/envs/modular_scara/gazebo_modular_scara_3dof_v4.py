...
class GazeboModularScara3DOFv4Env(gazebo_env.GazeboEnv):
    ...
    """
    def __init__(self, reward_type='sparse', distance_threshold=0.005, n_substeps=20, relative_control=False):
        """
    ...
    def step(self, action):
        ...
        if(self.rmse_func(self.ob['distance_from_goal'])<0.005):
            self.reward = 1 - self.rmse_func(self.ob['distance_from_goal']) # Make the reward increase as the distance decreases
