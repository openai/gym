...
export GYM_GAZEBO_WORLD_CIRCUIT="/gym-gazebo/gym_gazebo/envs/assets/worlds/circuit.world"
export GYM_GAZEBO_WORLD_CIRCUIT2="/gym-gazebo/gym_gazebo/envs/assets/worlds/circuit2.world"
