...
We currently support Linux and OS X. We don't have an official Windows support but some of the environments might still work by running `pip install gym`.
