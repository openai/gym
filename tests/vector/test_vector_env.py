...
def test_vector_env_equal(shared_memory):
    ...
    try:
        ...
        for _ in range(num_steps):
            ...
            if any(sync_dones):
                assert "closing_observation" in async_infos
                assert "_closing_observation" in async_infos
                assert "closing_observation" in sync_infos
                assert "_closing_observation" in sync_infos
