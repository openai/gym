"""
semisuper_pendulum_random is the pendulum task but where the reward function
...
class SemisuperPendulumRandomEnv(PendulumEnv):
    def _step(self, action):
        observation, true_reward, done, info = super(SemisuperPendulumRandomEnv, self)._step(action)
