...
for draw_tiles in range(2):
    ...
    register(
        id='meta-SuperMarioBros%s-v0' % (tile_suffix),
        entry_point='gym.envs.nes:MetaSuperMarioBrosEnv',
        timestep_limit=999999,
    ...
    for (world_number, level_number, area_number, max_distance) in SMB_LEVELS:
        ...
        register(
            id='SuperMarioBros-%d-%d%s-v0' % (world_number, level_number, tile_suffix),
            entry_point='gym.envs.nes:SuperMarioBrosEnv',
            timestep_limit=10000,
