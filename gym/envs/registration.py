...
class EnvRegistry(object):
    ...
    def make(self, id):
        ...
        # Automatically wrap envs with a TimeLimit wrapper, because the limit is part of the env semantics
        # Omit vnc envs for now, because autowrapping breaks `env.configure`
